...
public class DoorListFragmentLayout extends BaseFragmentLayout {
    private final String TAG = getClass().getSimpleName();
    private DoorListFragmentLayoutEvent mLayoutEvent;
    ...
    public DoorListFragmentLayout(BaseFragment fragment, DoorListFragmentLayoutEvent layoutEvent) {
        super(fragment);
    ...
    public interface DoorListFragmentLayoutEvent {
