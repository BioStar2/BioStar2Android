...
/**
 * @startuml package "UserData" {
 * interface Cloneable
 * interface Serializable
 * <p>
 * class Users {
 * @SerializedName("records") public ArrayList<ListUser> records;
 * }
 * <p>
 * class BaseUser {
 * @SerializedName("status_code") public String status_code;
 ...
 * @SerializedName("user_group") public BaseUserGroup user_group;
 * @SerializedName("access_groups") public ArrayList<ListAccessGroup> access_groups;
 * @SerializedName("fingerprint_count") public int fingerprint_count;
 * @SerializedName("card_count") public int card_count;
 * @SerializedName("pin_exist") public boolean pin_exist;
 * @SerializedName("photo_exist") public boolean photo_exist;
 * @SerializedName("last_modify") public String last_modify;
 * }
 * <p>
 * class User {
 * @SerializedName("password") public String password;
 * @SerializedName("security_level") public String security_level = "0";
 * @SerializedName("pin") public String pin;
 * @SerializedName("roles") public ArrayList<CloudRole> roles;
 * @SerializedName("photo") public String photo;
 * @SerializedName("login_id") public String login_id;
 * @SerializedName("phone_number") public String phone_number;
 * @SerializedName("status") public String status;
 * @SerializedName("fingerprint_templates") public ArrayList<ListFingerprintTemplate> fingerprint_templates;
 * @SerializedName("cards") public ArrayList<ListCard> cards;
 * @SerializedName("password_exist") public boolean password_exist;
 * @SerializedName("permissions") public ArrayList<CloudPermission> permissions;
 * @SerializedName("password_strength_level") public String password_strength_level;
 * @SerializedName("start_datetime") private String start_datetime;
 * @SerializedName("expiry_datetime") private String expiry_datetime;
