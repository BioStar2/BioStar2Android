...
public enum PermissionModule {
    ACCESS_GROUP("ACCESS_GROUP"), ACCESS_LEVEL("ACCESS_LEVEL"), ACCOUNT("ACCOUNT"), ADMIN("ADMIN"), CARD("CARD"), DEVICE("DEVICE"), DEVICE_GROUP("DEVICE_GROUP"), DOOR("DOOR"), DOOR_GROUP(
            "DOOR_GROUP"), HOLIDAY("HOLIDAY"), MONITORING("MONITORING"), PRIVILEGE("PRIVILEGE"), SCHEDULE("SCHEDULE"), SETTING_PREFERENCE("SETTING_PREFERENCE"),SETTING_NOTIFICATION("SETTING_NOTIFICATION"), USER("USER"), USER_GROUP(
            "USER_GROUP");
