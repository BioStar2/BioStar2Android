...
import com.supremainc.biostar2.sdk.volley.VolleyLog.MarkerLog;
...
//	private final Response.ErrorListener mErrorListener;
	...
	protected Object mDeliverParam;
	 ...
	 * 
	 * @deprecated Use
	 *             {@link #Request(int, String, com.supremainc.biostar2.sdk.volley.Response.ErrorListener)}
	 *             .
	 */
//	@Deprecated
//	public Request(String url, Response.ErrorListener listener,Object deliverParam) {
//		this(Method.DEPRECATED_GET_OR_POST, url, listener,deliverParam);
//	}
	 ...
	 * response.
	 */
	public Request(int method, String url, Response.ErrorListener listener,Object deliverParam) {
		mMethod = method;
		mUrl = url;
		mErrorListener = listener;
		mDeliverParam = deliverParam;
	...
	public String getUrl() {
		...
		if (mParams != null && mParams.size() > 0) {
			...
			try {
				...
				String url = mUrl + encodedParams.toString();
				return url;
