...
public class LoginData {
	public static class NotificationToken  implements Cloneable, Serializable  {
	...
	public static class Login extends NotificationToken implements Cloneable, Serializable  {
