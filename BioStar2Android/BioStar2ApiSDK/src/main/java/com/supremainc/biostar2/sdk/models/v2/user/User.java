...
public class User extends ListUser implements Cloneable, Serializable {
    ...
    @SerializedName("face_templates") // only 2.4.1
    ...
    public Calendar getTimeCalendar(DateTimeDataProvider convert, UserTimeType timeType) {
        return convert.convertServerTimeToCalendar(getTimeType(timeType), false);
    }

    public boolean setTimeCalendar(DateTimeDataProvider convert, UserTimeType timeType, Calendar cal) {
        switch (timeType) {
            case expiry_datetime:
    ...
    public String getTimeFormmat(DateTimeDataProvider convert, UserTimeType timeType, DateTimeDataProvider.DATE_TYPE type) {
        Calendar cal = getTimeCalendar(convert, timeType);
        return convert.convertCalendarToFormatter(cal, type);
    }

    public boolean setTimeFormmat(DateTimeDataProvider convert, UserTimeType timeType, DateTimeDataProvider.DATE_TYPE type, String src) {
