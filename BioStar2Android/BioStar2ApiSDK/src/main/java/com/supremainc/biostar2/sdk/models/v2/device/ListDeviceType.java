...
//            }
            if (scan_card) {
                support = support | com.supremainc.biostar2.sdk.models.v2.device.ListDeviceType.SUPPORT_CARD;
            }
            if (scan_fingerprint) {
                support = support | com.supremainc.biostar2.sdk.models.v2.device.ListDeviceType.SUPPORT_FINGERPRINT;
            }
            if (scan_face) {
                support = support | com.supremainc.biostar2.sdk.models.v2.device.ListDeviceType.SUPPORT_FACE;
            }
