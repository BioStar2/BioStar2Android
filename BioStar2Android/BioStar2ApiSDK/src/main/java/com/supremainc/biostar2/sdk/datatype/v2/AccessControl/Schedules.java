...
public class Schedules implements Cloneable, Serializable {
	public static final String TAG = Schedules.class.getSimpleName();
	...
	public Schedules clone() throws CloneNotSupportedException {
		Schedules target = (Schedules) super.clone();
		if (records != null) {
			target.records = (ScheduleCollection) records.clone();
		}
		return target;
	}
}