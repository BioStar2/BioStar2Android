...
import com.supremainc.biostar2.sdk.volley.DefaultRetryPolicy;
...
public class ImageRequest extends Request<Bitmap> {
    ...
    public ImageRequest(String url, Response.Listener<Bitmap> listener, int maxWidth, int maxHeight,
            Config decodeConfig, Response.ErrorListener errorListener,Object deliverParam) {
        super(Method.GET, url, errorListener,deliverParam);
        setRetryPolicy(
